        ...
        <div>
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li><a href="#">
                        <input type="submit" class=" btn-info btn-fill" value="交卷"
    ...
    <div style="margin-left: 20%;margin-right:20%;">
            <s:iterator value="#request.questions" status="st">
                <div style="margin-top:10px; font-size:18px;">
                    ...
                    &nbsp;&nbsp;&nbsp;<input type="radio" name="result"><s:property value="field1"/><br>
                    &nbsp;&nbsp;&nbsp;<input type="radio" name="result"><s:property value="field2"/><br>
                    <s:if test="field3!=null && field3 !=''.toString">
                        &nbsp;&nbsp;&nbsp;<input type="radio" name="result"><s:property value="field3"/><br>
                    </s:if>
                    <s:if test="field4!=null && field4 !=''.toString">
                        &nbsp;&nbsp;&nbsp;<input type="radio" name="result"><s:property value="field4"/>
                    </s:if>
                </div>
            </s:iterator>
