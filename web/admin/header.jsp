...
<nav class="navbar navbar-default navbar-fixed" style="height:auto;">
    <div class="container-fluid">
        ...
        <a class="logo1" title="虹软科技" href="admin/index.jsp" style="margin:10px;"></a>
        <div class="collapse navbar-collapse">
            ...
            <form method="post" action="getByKeywordOrName.action" id="form3">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="title1" href="admin/adminAddClass.jsp">添加课程</a></li>
                    <li><a class="title1" href="admin/getStudents.action">学生信息</a></li>
                    <%--<li><a class="title1" href="#">线下</a></li>--%>
