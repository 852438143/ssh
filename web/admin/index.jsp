...
<div class="wrapper">
    <div class="sidebar" data-color="purple"
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li id="id1"><a href="admin/getByKeyword.action?keyword=前端开发"> <i class="pe-7s-graph"></i>
                    <p>前端开发类课程</p>
                </a></li>
                <li id="id2"><a href="admin/getByKeyword.action?keyword=后端开发"> <i class="pe-7s-user"></i>
                    <p>服务端开发类课程</p>
                </a></li>
                <li id="id3"><a href="admin/getByKeyword.action?keyword=移动开发"> <i class="pe-7s-note2"></i>
                    <p>移动开发类课程</p>
                </a></li>
                <li id="id4"><a href="admin/getByKeyword.action?keyword=数据库"> <i class="pe-7s-news-paper"></i>
                    <p>数据库系统课程</p>
                </a></li>
                <li id="id5"><a href="admin/getByKeyword.action?keyword=云计算和大数据"> <i class="pe-7s-science"></i>
                    <p>机器学习类课程</p>
                </a></li>
                <li id="id6"><a href="admin/getByKeyword.action?keyword=运维和测试"> <i class="pe-7s-map-marker"></i>
                    <p>运维&测试类课程</p>
                </a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content all-icons">
                                <div class="row">
                                    <s:iterator value="#request.kcourse">
                                        <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                            <a href="paper/getPapersByCourseId.action?paper.courseId=<s:property value='courseId' />">
