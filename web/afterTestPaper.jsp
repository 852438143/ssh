...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            results = $("#result").val().split(",");
//        alert(results.length);
//        alert($("#result").val());
//        alert(results[0]);
//        alert($(".subResult").size());
            var i  =0;
            $(".subResult").each(function () {
//            alert(results[i]);
                $(this).text(results[i++]);
//            alert($(this).html());
            });
...
<div class="wrapper">
        ...
        <div>
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li><a href="#">
                        <p>考生编号:<s:property value="#request.paper.studentId"/></p>
                    </a></li>
                    <li><a href="#">
                        <p>考生姓名:<s:property value="#session.student.studentName"/></p>
                    </a></li>
                    <li><a href="#">
                    <p>考试成绩:<s:property value="#request.paper.score"/></p>
                    </a></li>
                    <%--<li><a href="#">--%>
    ...
    <div style="margin-left: 20%;margin-right:20%;">
            <input type="hidden" id="result" value="<s:property value="#request.paper.result"/>">
            <s:iterator value="#request.questions" status="st">
                <div style="margin-top:10px; font-size:18px;">
                    ...
                    &nbsp;&nbsp;&nbsp;<s:property value="field1"/><br>
                    &nbsp;&nbsp;&nbsp;<s:property value="field2"/><br>
                    <s:if test="field3!=null && field3 !=''.toString">
                        &nbsp;&nbsp;&nbsp;<s:property value="field3"/><br>
                    </s:if>
                    <s:if test="field4!=null && field4 !=''.toString">
                        &nbsp;&nbsp;&nbsp;<s:property value="field4"/><br>
                    </s:if>
                    你的答案:<span class="subResult"></span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    正确答案:<s:property value="answer"/> <br>
                </div>
            </s:iterator>
